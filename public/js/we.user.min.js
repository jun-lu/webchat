...
WE.userPage.home={tmpl:'<li>\t\t\t\t<div class="avatar pull-left">\t\t\t\t\t<a href="/user/<%=_id %>">\t\t\t\t\t\t<img src="<%=avatar %>">\t\t\t\t\t</a>\t\t\t\t</div>\t\t\t\t<div class="info pull-left">\t\t\t\t\t<a href="/user/<%=_id %>"><%= name == "" ? "(\u672a\u8bbe\u7f6e\u6635\u79f0)" : name %></a>\t\t\t\t\t<span><%=WE.kit.cutOff(summary,30)  %></span>\t\t\t\t</div>\t\t\t</li>',noTmpl:"<li>\t\t\t\t<span>No contects...</span>\t\t\t</li>",init:function(){this.ui={list:$("#contacts")};this.loadContacts()},
