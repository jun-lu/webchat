...
WE.userPage.bindMail={init:function(){this.ui={submit:$("#bindMail-submit"),input:$("#bindMail-input"),pwd:$("#pwd-input"),tips:$("#bindMail-tip")};this.regEvent()},regEvent:function(){var a=this;this.ui.submit.click(function(){var b=$.trim(a.ui.input.val()),c=$.trim(a.ui.pwd.val());""!=b&&""!=c&&(/^[^@]+@[^@]+$/.test(b)?a.verifMail(b,c,a.updateMail,a.errorTip):a.errorTip("Please enter a valid email"))})},verifMail:function(a,b,c,d){var e=new WE.api.UserModel,f=new WE.Controller;f.update=function(e){0==
e.data.code?c&&c(a,b):d&&d("Email is exit! please try others")};e.addObserver(f);e.verifMail(a)},updateMail:function(a,b){var c=new WE.api.UserModel,d=new WE.Controller;d.update=function(a){0==a.data.code&&loaction.reload()};c.addObserver(d);c.updateMail(a)},errorTip:function(a){this.ui.tips.text(a).removeClass("hidden")}};
