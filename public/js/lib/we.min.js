...
getTmpl:function(a,b){var c=this;c.cache[a]?b&&b(c.cache[a]):$.ajax({url:"/api/tmpl",medthod:"get",data:{path:a},success:function(d){c.cache[a]=d;b&&b(d)}})},getRadioValue:function(a){return $("input[type=radio][name="+a+"]:checked").val()},weTime:function(){var a=[{t:6E4,s:"\u521a\u521a"},{t:12E4,s:"1\u5206\u949f"},{t:18E4,s:"2\u5206\u949f"},{t:36E4,s:"5\u5206\u949f"},{t:66E4,s:"10\u5206\u949f"},{t:18E5,s:"30\u5206\u949f"},{t:36E5,s:"1\u5c0f\u65f6"},{t:72E5,s:"2\u5c0f\u65f6"},{t:18E6,s:"5\u5c0f\u65f6"},
{t:864E5,s:"1\u5929\u524d"},{t:1728E5,s:"2\u5929\u524d"}];return function(b){for(var c=(new Date).getTime()-b,d=0;d<a.length;)if(a[d++].t>c)return a[d-1].s;return WE.kit.format(b,"MM-dd hh:mm:ss")}}(),getAvatar:function(a,b,c){return"http://www.gravatar.com/avatar/"+(a||"00000000000000000000000000000000")+"?s="+(b||48)+"&d="+(c||"mm")},chatFormate:function(a){return a.replace(/\n/gi,"<br/>").replace(/http:\/\/[\w\.\/\:\?\&\=\#\-\_]+/gi,function(a){return'<a href="'+a+'" target="_blank">'+a+"</a>"})},
removeHtmlTag:function(a){return a.replace(/<|>/g,function(a){return"<"==a?"&lt;":"&gt;"})},revertHtmlTag:function(a){return a.replace(/\n/gi,"<br/>").replace(/http:\/\/[\w\.\/\:\?\&\=\#\-\_]+/gi,function(a){return'<a href="'+a+'" target="_blank">'+a+"</a>"})},getHidden:function(){var a;"undefined"!==typeof document.hidden?a="hidden":"undefined"!==typeof document.mozHidden?a="mozHidden":"undefined"!==typeof document.msHidden?a="msHidden":"undefined"!==typeof document.webkitHidden&&(a="webkitHidden");
return document[a]},titleRoll:function(a,b){var c=a.split("");setInterval(function(){c.push(c[0]);c.shift();document.title=c.join("")},b)}});WE.extend(WE.ui,{ok:function(a,b){var c=this.tip({context:a,okbtn:!1,cancelbtn:!1,type:"success",timeout:b||3E3,title:"\u63d0\u793a"});c.ui.close.focus();return c},alert:function(a,b){this.alert.tip&&(this.alert.tip.option.callback=null,this.alert.tip.close());var c=this.tip({context:a,cancelbtn:!1,type:"notice",callback:b,title:"\u63d0\u793a"});c.ui.ok.focus();return this.alert.tip=c},confirm:function(a,b){if(this.confirm.tip)return this.confirm.tip;var c=this,d=this.tip({context:a,closebtn:!1,type:"notice",
