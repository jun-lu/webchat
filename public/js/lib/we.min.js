...
b=Array(b-String(a).length||0);b.push(a);return b.join(c||"0")},format:function(a,b){a=new Date(a);var c=this.pad,d={yy:String(a.getFullYear()).slice(-2),yyyy:a.getFullYear(),M:a.getMonth()+1,MM:c(a.getMonth()+1,2,"0"),d:a.getDate(),dd:c(a.getDate(),2,"0"),h:a.getHours(),hh:c(a.getHours(),2,"0"),m:a.getMinutes(),mm:c(a.getMinutes(),2,"0"),s:a.getSeconds(),ss:c(a.getSeconds(),2,"0")};return(b||"yyyy-MM-dd hh:mm:ss").replace(/yyyy|yy|MM|M|dd|d|hh|h|mm|m|ss|s/g,function(a){return d[a]})},sortFormat:function(a){return this.format(a,
"yyyy-MM-dd")},longFormat:function(a){return this.format(a,"yyyy-MM-dd hh:mm:ss")},getTmpl:function(a,b){var c=this;c.cache[a]?b&&b(c.cache[a]):$.ajax({url:"/api/tmpl",medthod:"get",data:{path:a},success:function(d){c.cache[a]=d;b&&b(d)}})},getRadioValue:function(a){return $("input[type=radio][name="+a+"]:checked").val()},weTime:function(){var a=[{t:6E4,s:"\u521a\u521a"},{t:12E4,s:"1\u5206\u949f"},{t:18E4,s:"2\u5206\u949f"},{t:36E4,s:"5\u5206\u949f"},{t:66E4,s:"10\u5206\u949f"},{t:18E5,s:"30\u5206\u949f"},
{t:36E5,s:"1\u5c0f\u65f6"},{t:72E5,s:"2\u5c0f\u65f6"},{t:18E6,s:"5\u5c0f\u65f6"},{t:864E5,s:"1\u5929\u524d"},{t:1728E5,s:"2\u5929\u524d"}];return function(b){for(var c=(new Date).getTime()-b,d=0;d<a.length;)if(a[d++].t>c)return a[d-1].s;return WE.kit.format(b,"MM-dd hh:mm:ss")}}(),getAvatar:function(a,b,c){return"http://www.gravatar.com/avatar/"+(a||"00000000000000000000000000000000")+"?s="+(b||48)+"&d="+(c||"mm")},chatFormate:function(a){return a.replace(/\n/gi,"<br/>").replace(/http:\/\/[\w\.\/\:\?\&\=\#\-\_]+/gi,
function(a){return'<a href="'+a+'" target="_blank">'+a+"</a>"})},removeHtmlTag:function(a){return a.replace(/<|>/g,function(a){return"<"==a?"&lt;":"&gt;"})},revertHtmlTag:function(a){return a.replace(/\n/gi,"<br/>").replace(/http:\/\/[\w\.\/\:\?\&\=\#\-\_]+/gi,function(a){return'<a href="'+a+'" target="_blank">'+a+"</a>"})},getHidden:function(){var a;"undefined"!==typeof document.hidden?a="hidden":"undefined"!==typeof document.mozHidden?a="mozHidden":"undefined"!==typeof document.msHidden?a="msHidden":
"undefined"!==typeof document.webkitHidden&&(a="webkitHidden");return document[a]},titleRoll:function(a,b){var c=a.split("");setInterval(function(){c.push(c[0]);c.shift();document.title=c.join("")},b)}});WE.extend(WE.ui,{ok:function(a,b){var c=this.tip({context:a,okbtn:!1,cancelbtn:!1,type:"success",timeout:b||3E3,title:"\u63d0\u793a"});c.ui.close.focus();return c},alert:function(a,b){this.alert.tip&&(this.alert.tip.option.callback=null,this.alert.tip.close());var c=this.tip({context:a,cancelbtn:!1,type:"notice",callback:b,title:"\u63d0\u793a"});c.ui.ok.focus();return this.alert.tip=c},confirm:function(a,b){if(this.confirm.tip)return this.confirm.tip;var c=this,d=this.tip({context:a,closebtn:!1,type:"notice",
...
this.setFoucs()},setClear:function(){this.ui.textarea.val("");this.removeReply()},setLock:function(){this.islock=!0;this.ui.postSendBtn.attr("disabled",!0)},setFoucs:function(){this.ui.textarea.focus()},removeLock:function(){this.islock=!1;this.ui.postSendBtn.attr("disabled",!1)},removeReply:function(){this.ui.aim.val("");this.ui.quote.hide()}};WE.api=WE.api||{};WE.api.RoomModel=function(){this.postUrl="/sys/post";this.updateRoomURL="/api/room-update";this.historyListURL="/api/room-visitors-get";this.uniqueKeyURL="/api/room-key-verify";this.getMoreURL="/api/room-chat-get";this.createRoomURL="/api/room-create"};WE.api.RoomModel.prototype=WE.BaseModel.prototype;WE.api.RoomModel.prototype.mpostChat=function(a,b,c){a={roomid:a,text:b};c&&(a.aim=c);a.to="*";this.post(this.postUrl,a)};
WE.api.RoomModel.prototype.postChat=function(a,b,c){this.post(this.postUrl,{roomid:a,text:b,to:"*",aim:c})};WE.api.RoomModel.prototype.create=function(a,b,c){this.post(this.createRoomURL,{topic:a,des:b,pwd:c})};WE.api.RoomModel.prototype.updateRoom=function(a,b,c,d,e){this.post(this.updateRoomURL,{id:a,name:b,topic:c,des:d,password:e})};WE.api.RoomModel.prototype.getMore=function(a,b){this.get(this.getMoreURL,{roomid:a,time:b})};
WE.api.RoomModel.prototype.historyList=function(a){this.get(this.historyListURL,{roomid:a,size:24})};WE.api.RoomModel.prototype.uniqueKey=function(a){this.get(this.uniqueKeyURL,{key:a})};WE.api=WE.api||{};WE.api.NoticeModel=function(){this.noticeCountUrl="/api/notice-count";this.noticeListUrl="/api/notice-list";this.noticeStatusUrl="/api/notice-status"};WE.api.NoticeModel.prototype=WE.BaseModel.prototype;WE.api.NoticeModel.prototype.noticeCount=function(){this.get(this.noticeCountUrl)};WE.api.NoticeModel.prototype.noticeList=function(){this.get(this.noticeListUrl)};WE.api.NoticeModel.prototype.noticeStatus=function(a){this.post(this.noticeStatusUrl,{_id:a})};WE.api=WE.api||{};WE.api.UserModel=function(){this.bindMailURL="/api/user-mail-set";this.setUserNameURL="/api/user-name-update";this.updateAvatorURL="/api/user-avatar-update";this.updateSummaryUrl="/api/user-summary-update"};WE.api.UserModel.prototype=WE.BaseModel.prototype;WE.api.UserModel.prototype.updateUserName=function(a){this.post(this.setUserNameURL,{name:a})};WE.api.UserModel.prototype.updateMail=function(a,b){this.post(this.bindMailURL,{mail:a,pwd:b})};
WE.api.UserModel.prototype.updateAvator=function(a){this.post(this.updateAvatorURL,{gravatarDefault:a})};WE.api.UserModel.prototype.updateUserSummery=function(a){this.post(this.updateSummaryUrl,{summary:a})};
