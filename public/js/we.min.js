...
1;this.postType=a;var b=this.ui.btnGroup.find(".dropdown-menu a");b.find("span:first").hide();b.eq(a==2?0:1).find("span:first").show()},regEvent:function(){var a=this;this.ui.form.submit(function(){var b=$.trim(a.ui.textarea.val()),c=a.ui.to.val(),d=a.ui.roomid.val();if(b&&a.islock==!1)a.onpost(d,d,c);return!1});this.ui.fullscreen.click(function(){a.dom.toggleClass("fullscreen");a.isFullscreen=a.isFullscreen?!1:!0;a.updateTextareaHeight()});this.ui.btnGroup.find(".dropdown-toggle").click(function(){a.ui.btnGroup.toggleClass("open");
