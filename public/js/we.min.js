...
s:"2\u5c0f\u65f6"},{t:18E6,s:"5\u5c0f\u65f6"},{t:864E5,s:"1\u5929\u524d"},{t:1728E5,s:"2\u5929\u524d"}];return function(b){for(var c=(new Date).getTime()-b,d=0;d<a.length;)if(a[d++].t>c)return a[d-1].s;return WE.kit.format(b,"hh:mm:ss")}}()});WE.extend(WE.kit,function(){function a(b){var a={dragElement:null,moveElement:null,isRange:!0,isResize:!0,patchWidth:0,patchHeight:0,patchTop:0,patchLeft:0};this.left=this.top=this.height=this.width=0;$.extend(a,b);this.option=a;this.events={}}a.prototype={init:function(){var b=this;this.option.iscap=this.option.dragElement[0].setCapture?!0:!1;$.extend(this.events,{down:function(a){b.down(a);return!1},up:function(a){b.up(a);return!1},move:function(a){b.move(a);return!1}});this.zIndex();this.createMask();
