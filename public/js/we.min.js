...
WE.Dialog.prototype={constructor:WE.Dialog,init:function(){var a=this;this.id&&WE.Dialog.setItem(this.id,this);document.body.appendChild(this.ui.wrap[0]);this.ui.context.width(this.width);this.ui.context.height(this.height);this.updatePosition();this.ui.wrap.delegate(".out","click",function(){a.close(1)})},append:function(a){this.ui.context.css({width:"auto",height:"auto"}).removeClass("we-loading");this.ui.context.html(a);this.width=this.ui.dialog.width();this.height=this.ui.dialog.height();this.updatePosition()},
updatePosition:function(){this.ui.dialog.css({top:"30%",left:"50%",marginTop:-(this.height/2-10)+"px",marginLeft:-(this.width/2)+"px"})},show:function(){this.ui.mask.animate({opacity:1},300);this.ui.dialog.animate({marginTop:"+=10px",opacity:1},300)},close:function(){var a=this;this.ui.mask.animate({opacity:0},300);this.ui.dialog.animate({marginTop:"-=10px",opacity:0},300,function(){a.ui.wrap.remove();WE.Dialog.remove(a.id)})},onclose:function(){return!0}};
