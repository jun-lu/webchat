...
a)},setPos:function(a,c){this.ui.wrapper.css({top:a+"px",left:c+"px"})}};return function(b){return new a(b)}}()});WE.Dialog=function(a){var b=null;if((this.id=a.id)&&WE.Dialog.getItem(this.id))return b=WE.Dialog.getItem(this.id),b.isRepeat=!0,b.isRepeat;this.title=a.title||"";this.html=a.html;this.width=a.width||100;this.height=a.height||50;this.wrap=$(WE.Dialog.html.replace("<%=title%>",this.title));this.ui={wrap:this.wrap,mask:this.wrap.find(".we-mask"),dialog:this.wrap.find(".we-dialog"),context:this.wrap.find(".we-dialog-context")};this.init()};WE.Dialog.html='<div class="we-dialog-box">\t\t<div class="we-mask" style="opacity:0" ></div>\t\t<div class="we-dialog" style="opacity:0">\t\t\t<div class="we-dialog-title">\t\t\t\t<h1><%=title%></h1>\t\t\t\t<a href="javascript:;" class="we-dialog-close out"></a>\t\t\t</div>\t\t\t<div class="we-dialog-context we-loading"></div>\t\t</div>\t</div>';
...
WE.Dialog.prototype={constructor:WE.Dialog,init:function(){var a=this;this.id&&WE.Dialog.setItem(this.id,this);document.body.appendChild(this.ui.wrap[0]);this.updatePosition();this.ui.wrap.delegate(".out","click",function(){a.close(1)})},append:function(a){var b=this;this.ui.context.html(a).removeClass("we-loading");setTimeout(function(){b.width=b.ui.dialog.width();b.height=b.ui.dialog.height();b.updatePosition()},100)},updatePosition:function(){this.ui.dialog.css({top:"30%",left:"50%",marginTop:-(this.height/
2-10)+"px",marginLeft:-(this.width/2)+"px"})},show:function(){this.ui.mask.animate({opacity:1},300);this.ui.dialog.animate({marginTop:"+=10px",opacity:1},300)},close:function(){var a=this;this.ui.mask.animate({opacity:0},300);this.ui.dialog.animate({marginTop:"-=10px",opacity:0},300,function(){a.ui.wrap.remove();WE.Dialog.remove(a.id)})},onclose:function(){return!0}};
