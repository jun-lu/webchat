...
0)return a;b=Array(b-String(a).length||0);b.push(a);return b.join(c||"0")},format:function(a,b){var a=new Date(a),c=this.pad,d={yy:String(a.getFullYear()).slice(-2),yyyy:a.getFullYear(),M:a.getMonth()+1,MM:c(a.getMonth()+1,2,"0"),d:a.getDate(),dd:c(a.getDate(),2,"0"),h:a.getHours(),hh:c(a.getHours(),2,"0"),m:a.getMinutes(),mm:c(a.getMinutes(),2,"0"),s:a.getSeconds(),ss:c(a.getSeconds(),2,"0")};return(b||"yyyy-MM-dd hh:mm:ss").replace(/yyyy|yy|MM|M|dd|d|hh|h|mm|m|ss|s/g,function(a){return d[a]})},
sortFormat:function(a){return this.format(a,"yyyy-MM-dd")},longFormat:function(a){return this.format(a,"yyyy-MM-dd hh:mm:ss")},getTmpl:function(a,b){var c=this;c.cache[a]?b&&b(c.cache[a]):$.ajax({url:"/sys/tmpl",medthod:"get",data:{path:a},success:function(d){c.cache[a]=d;b&&b(d)}})},getRadioValue:function(a){return $("input[type=radio][name="+a+"]:checked").val()},weTime:function(){var a=[{t:6E4,s:"\u521a\u521a"},{t:12E4,s:"1\u5206\u949f"},{t:18E4,s:"2\u5206\u949f"},{t:36E4,s:"5\u5206\u949f"},{t:66E4,
s:"10\u5206\u949f"},{t:18E5,s:"30\u5206\u949f"},{t:36E5,s:"1\u5c0f\u65f6"},{t:72E5,s:"2\u5c0f\u65f6"},{t:18E6,s:"5\u5c0f\u65f6"},{t:864E5,s:"1\u5929\u524d"},{t:1728E5,s:"2\u5929\u524d"}];return function(b){for(var c=(new Date).getTime()-b,d=0;d<a.length;)if(a[d++].t>c)return a[d-1].s;return WE.kit.format(b,"MM-dd hh:mm:ss")}}(),getAvatar:function(a,b,c){return"http://www.gravatar.com/avatar/"+(a||"00000000000000000000000000000000")+"?s="+(b||48)+"&d="+(c||"mm")},chatFormate:function(a){return a.replace(/\n/gi,
"<br/>").replace(/http:\/\/[\w\.\/\:\?\&\=\#\-\_]+/gi,function(a){return'<a href="'+a+'" target="_blank">'+a+"</a>"})},removalHtmlTag:function(a){return a.replace(/<|>/g,function(a){return a=="<"?"&lt;":"&gt;"})},revertHtmlTag:function(a){return a.replace(/\n/gi,"<br/>").replace(/http:\/\/[\w\.\/\:\?\&\=\#\-\_]+/gi,function(a){return'<a href="'+a+'" target="_blank">'+a+"</a>"})},getHidden:function(){var a;typeof document.hidden!=="undefined"?a="hidden":typeof document.mozHidden!=="undefined"?a="mozHidden":
typeof document.msHidden!=="undefined"?a="msHidden":typeof document.webkitHidden!=="undefined"&&(a="webkitHidden");return document[a]},titleRoll:function(a,b){var c=a.split("");setInterval(function(){c.push(c[0]);c.shift();document.title=c.join("")},b)}});WE.extend(WE.ui,{ok:function(a,b){var c=this.tip({context:a,okbtn:!1,cancelbtn:!1,type:"success",timeout:b||3E3,title:"\u63d0\u793a"});c.ui.close.focus();return c},alert:function(a,b){if(this.alert.tip)this.alert.tip.option.callback=null,this.alert.tip.close();var c=this.tip({context:a,cancelbtn:!1,type:"notice",callback:b,title:"\u63d0\u793a"});c.ui.ok.focus();return this.alert.tip=c},confirm:function(a,b){if(this.confirm.tip)return this.confirm.tip;var c=this,d=this.tip({context:a,closebtn:!1,type:"notice",
...
<<<<<<< HEAD
a)},setPos:function(a,c){this.ui.wrapper.css({top:a+"px",left:c+"px"})}};return function(b){return new a(b)}}()});WE.extend(WE.markdown,{defaultPrefix:"```",format:function(a){var b="",b=this.preFormat(a);return b=this.urlFormat(b)},preFormat:function(a){if(a.length>0){var b=a.split(this.defaultPrefix).length-1;if(b!=0&&b%2==0){var c=0;return a.replace(RegExp(this.defaultPrefix,"g"),function(){c++;return c%2==0?"</pre>":"<pre>"})}else return a}else return!1},urlFormat:function(a){return a.replace(/\n/gi,"<br/>").replace(/(http|https):\/\/[\w\.\/\:\?\&\=\#\-\_]+/gi,function(a){return'<a href="'+a+'" target="_blank">'+
a+"</a>"})}});WE.Dialog=function(a){var b=null;if((this.id=a.id)&&WE.Dialog.getItem(this.id))return b=WE.Dialog.getItem(this.id),b.isRepeat=!0,b.isRepeat;this.title=a.title||"";this.html=a.html;this.width=a.width||200;this.height=a.height||60;this.wrap=$(WE.Dialog.html.replace("<%=title%>",this.title));this.ui={wrap:this.wrap,mask:this.wrap.find(".we-mask"),dialog:this.wrap.find(".we-dialog"),context:this.wrap.find(".we-dialog-context")};this.init()};WE.Dialog.html='<div class="we-dialog-box">\t\t<div class="we-mask" style="opacity:0" ></div>\t\t<div class="we-dialog" style="opacity:0">\t\t\t<div class="we-dialog-title">\t\t\t\t<h1><%=title%></h1>\t\t\t\t<a href="javascript:;" class="we-dialog-close out"></a>\t\t\t</div>\t\t\t<div class="we-dialog-context we-loading"></div>\t\t</div>\t</div>';
=======
a)},setPos:function(a,c){this.ui.wrapper.css({top:a+"px",left:c+"px"})}};return function(b){return new a(b)}}()});WE.extend(WE.markdown,{defaultPrefix:"````",format:function(a){var b="";this.preFormat(a);return b=this.urlFormat(a)},preFormat:function(a){if(a.length>0){if(a.split(this.defaultPrefix),prefixsLen!=0&&prefixsLen%2==0){var b=0;return a.replace(RegExp(this.defaultPrefix,"g"),function(){b++;return b%2==0?"</pre>":"<pre>"})}}else return!1},urlFormat:function(a){return a.replace(/\n/gi,"<br/>").replace(/(http|https):\/\/[\w\.\/\:\?\&\=\#\-\_]+/gi,function(a){return'<a href="'+a+'" target="_blank">'+a+
"</a>"})}});WE.Dialog=function(a){var b=null;if((this.id=a.id)&&WE.Dialog.getItem(this.id))return b=WE.Dialog.getItem(this.id),b.isRepeat=!0,b.isRepeat;this.title=a.title||"";this.html=a.html;this.width=a.width||200;this.height=a.height||60;this.wrap=$(WE.Dialog.html.replace("<%=title%>",this.title));this.ui={wrap:this.wrap,mask:this.wrap.find(".we-mask"),dialog:this.wrap.find(".we-dialog"),context:this.wrap.find(".we-dialog-context")};this.init()};WE.Dialog.html='<div class="we-dialog-box">\t\t<div class="we-mask" style="opacity:0" ></div>\t\t<div class="we-dialog" style="opacity:0">\t\t\t<div class="we-dialog-title">\t\t\t\t<h1><%=title%></h1>\t\t\t\t<a href="javascript:;" class="we-dialog-close out"></a>\t\t\t</div>\t\t\t<div class="we-dialog-context we-loading"></div>\t\t</div>\t</div>';
>>>>>>> 39cbcf45d72e7a3742f7edbfeb273d12e91c3819
...
WE.Dialog.prototype={constructor:WE.Dialog,init:function(){var a=this;this.id&&WE.Dialog.setItem(this.id,this);document.body.appendChild(this.ui.wrap[0]);this.updatePosition();this.ui.wrap.delegate(".out","click",function(){a.close(1)})},append:function(a){this.ui.context.html(a).removeClass("we-loading");this.updatePosition()},updatePosition:function(){this.width=this.ui.dialog.width();this.height=this.ui.dialog.height();this.ui.dialog.css({top:($(window).height()-this.height)/2*0.6+"px",left:($(window).width()-
this.width)/2+"px"})},show:function(){this.ui.mask.animate({opacity:1},300);this.ui.dialog.animate({marginTop:"+=10px",opacity:1},300)},close:function(){var a=this;this.ui.mask.animate({opacity:0},300);this.ui.dialog.animate({marginTop:"-=10px",opacity:0},300,function(){a.ui.wrap.remove();WE.Dialog.remove(a.id)})},onclose:function(){return!0}};
WE.ui.Post=function(a){this.quotetmpl='<span class="quote-text"><%=text%></span>\t\t\t\t<a href="/user/<%=uid%>" class="quote-user"><%=uname%></a>\t\t\t\t<a class="quote-del pull-right" href="javascript:;">\u00d7</a>';this.islock=!1;this.dom=$(a);this.postType=1;this.isFullscreen=!1;this.init()};
WE.ui.Post=function(a){this.quotetmpl='<span class="quote-text"><%=text%></span>\t\t\t\t<a href="/user/<%=uid%>" class="quote-user"><%=uname%></a>\t\t\t\t<a class="quote-del pull-right" href="javascript:;">\u00d7</a>';this.islock=!1;this.dom=$(a);this.postType=1;this.isFullscreen=!1;this.init()};
WE.ui.Post.prototype={construcotr:WE.ui.Post,init:function(){var a=this.dom;this.ui={form:a.find("form:first"),to:a.find(".jsto"),roomid:a.find(".jsroomid"),textarea:a.find("textarea:first"),fullscreen:a.find(".icon-fullscreen"),btnGroup:a.find(".btn-group"),quote:a.find(".quote"),postSendBtn:a.find(".postSendBtn"),modeEdit:a.find(".jsmodeEdit"),modePreview:a.find(".jsmodePreview"),jspreviewbox:a.find(".jspreviewbox")};this.regEvent();this.initSendType()},initSendType:function(){var a=localStorage.getItem("sendType")||
1;this.postType=a;var b=this.ui.btnGroup.find(".dropdown-menu a");b.find("span:first").hide();b.eq(a==2?0:1).find("span:first").show()},regEvent:function(){var a=this;this.ui.form.submit(function(){var b=$.trim(a.ui.textarea.val()),c=a.ui.to.val(),d=a.ui.roomid.val();if(b&&a.islock==!1)a.onpost(d,b,c);return!1});this.ui.fullscreen.click(function(){a.dom.toggleClass("fullscreen");a.isFullscreen=a.isFullscreen?!1:!0;a.updateTextareaHeight()});this.ui.btnGroup.find(".dropdown-toggle").click(function(){a.ui.btnGroup.toggleClass("open");
return!1});this.ui.btnGroup.find(".dropdown-menu a").click(function(){a.ui.btnGroup.toggleClass("open");a.postType=$(this).data("type");localStorage.setItem("sendType",a.postType);a.initSendType()});this.ui.textarea.keydown(function(b){if(b.keyCode==13&&a.postType==2&&a.isFullscreen==!1)return a.ui.form.trigger("submit"),!1});this.ui.modeEdit.click(function(){a.ui.jspreviewbox.hide();a.ui.textarea.show();a.ui.modePreview.removeClass("active");a.ui.modeEdit.addClass("active")});this.ui.modePreview.click(function(){a.ui.textarea.hide();
a.ui.jspreviewbox.show();a.ui.jspreviewbox.html(WE.markdown.format(a.ui.textarea.val()));a.ui.modeEdit.removeClass("active");a.ui.modePreview.addClass("active")});$(window).resize(function(){a.isFullscreen&&a.updateTextareaHeight()})},updateTextareaHeight:function(){if(this.isFullscreen){var a=$(window).height();this.ui.textarea.css("minHeight",a-48-26+"px");this.ui.jspreviewbox.css("minHeight",a-48-26+"px")}else this.ui.textarea.css("minHeight","45px"),this.ui.jspreviewbox.css("minHeight","45px")},
onpost:function(){},setMini:function(){this.isFullscreen=!1;this.dom.removeClass("fullscreen");this.updateTextareaHeight()},setReply:function(a){var b=this,c=WE.kit.tmpl(this.quotetmpl,a);this.ui.to.val(a._id);this.ui.quote.html(c).show();this.ui.quote.find(".quote-del").click(function(){b.removeReply()})},setClear:function(){this.ui.textarea.val("");this.removeReply()},setLock:function(){this.islock=!0;this.ui.postSendBtn.attr("disabled",!0)},setFoucs:function(){this.ui.textarea.focus()},removeLock:function(){this.islock=
!1;this.ui.postSendBtn.attr("disabled",!1)},removeReply:function(){this.ui.to.val("");this.ui.quote.hide()}};
