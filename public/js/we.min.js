...
a)},setPos:function(a,c){this.ui.wrapper.css({top:a+"px",left:c+"px"})}};return function(b){return new a(b)}}()});WE.extend(WE.markdown,{defaultPrefix:"```",format:function(a){String(a).length>0&&(a=WE.kit.removalHtmlTag(a),a=this.lineFormat(a),a=this.preFormat(a),a=this.urlFormat(a));return a},preFormat:function(a){if(a.length>0){var b=a.split(this.defaultPrefix).length-1;if(b!=0&&b%2==0){var c=0;return a.replace(RegExp(this.defaultPrefix,"g"),function(){c++;return c%2==0?"</pre>":"<pre>"})}else return a}else return!1},urlFormat:function(a){return a.replace(/(http|https):\/\/[\w\.\/\:\?\&\=\#\-\_]+/gi,function(a){return'<a href="'+
