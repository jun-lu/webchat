...
searchTmpl:'<a class="key" href="/search?key=<%=encodeURIComponent(key) %>">Search Topics for "<%=key.replace(/</g,"&lt;").replace(/>/g,"&gt;") %>"</a>',setResult:function(b,a){var c="",d=a.length;if(0<a.length)for(var e=0;e<d;e++)c+=WE.kit.tmpl(this.resultTmpl,a[e]);c+=WE.kit.tmpl(this.searchTmpl,{key:b});this.ui.loading.hide();this.ui.results.empty().addClass("hidden");this.ui.results.html(c);this.index=-1;this.maxIndex=d+1;this.datas=a;this.ui.results.removeClass("hidden")},index:-1,maxIndex:0,
datas:null,select:function(b){var a=this.index,c=this.maxIndex,d=this.ui.results.find("a");d.eq(-1==a?c-1:a).removeClass("select");a+=b;a=a>c?0:a;a=0>a?c:a;-1!=a&&d.eq(a).addClass("select");-1!=a&&this.ui.input.val(""==d.eq(a).text()?this.value:d.eq(a).text());this.index=a}};
WE.top.notice={hasNotices:!1,noticeTmpl:'<li>\t\t\t\t\t<a href="/user/<%=from._id %>"><%=from.name %></a> \u5728 <a href="/d/<%=response %>?noticeid=<%=_id %>"><%=where.topic %></a> \u56de\u590d\u4e86\u4f60\t\t\t\t\t<span class="know" data-nid="<%=_id %>">\u4e0d\u518d\u63d0\u9192</span>\t\t\t\t</li>',noResultTmpl:'<p class="no-notice">\u6ca1\u6709\u6700\u65b0\u7684\u901a\u77e5...</p>',init:function(){var b=$("#notice-box");this.ui={wall:b,bell:b.find(".bell"),list:b.find(".notice-list")};this.getStatus();
this.regEvent()},pollPoint:null,poll:function(){},regEvent:function(){var b=this;$("body").click(function(){b.ui.list.hide()});this.ui.wall.click(function(a){a.stopPropagation();b.ui.list.show()});this.ui.bell.click(function(a){clearInterval(b.pollPoint);b.hasNotices=!1;b.setBellStatus(0);b.getNotices();b.ui.list.removeClass("hidden");a.preventDefault()});this.ui.list.delegate(".know","click",function(){var a=$(this),c=a.attr("data-nid"),d=new WE.api.NoticeModel,e=new WE.Controller;e.update=function(c){0==
c.data.code&&(a.animate({height:"0px"},800,function(){a.remove()}),b.getNotices())};d.addObserver(e);d.noticeStatus(c)})},getStatus:function(){var b=this,a=new WE.api.NoticeModel,c=new WE.Controller;c.update=function(a){a=a.data;if(0==a.code){if(0==a.result)return b.hasNotices=!1;b.hasNotices=!0;b.setBellStatus(1)}};a.addObserver(c);a.noticeCount()},setBellStatus:function(b){b?this.ui.bell.find("i").removeClass("icon-noticedefault").addClass("icon-noticeaction"):this.ui.bell.find("i").removeClass("icon-noticeaction").addClass("icon-noticedefault")},
