...
WE.pageTop.notice={isShowContent:!1,noticeCount:0,init:function(){var a=$("#notice-box");this.ui={box:a,circle:a.find(".circle"),list:a.find(".notice-list"),title:a.find(".notice-title"),content:a.find(".notice-content"),loading:a.find(".we-loading"),allLink:a.find(".notic-all")};this.setNoticeCount();this.regEvent()},regEvent:function(){var a=this;a.ui.title.click(function(){a.isShowContent?(a.ui.content.hide(),a.isShowContent=!1):(a.isShowContent=!0,a.ui.content.show(),a.getNoticeList())});a.ui.list.delegate(".del",
"click",function(){var c=$(this).attr("data-mid");a.deleteOne(c);$(this).parent("li").animate({opacity:0},800,function(){$(this).remove()});return!1});$(document.body).click(function(){a.isShowContent=!1;a.ui.content.hide()});a.ui.box.click(function(a){a.stopPropagation()})},noticeItemTmpl:'<li>\t\t\t\t\t\t<a target="_blank" href="/user/<%=from._id%>"><%= from.name %></a> \u5728\t\t\t\t\t\t<a target="_blank" data-mid="<%= _id %>" class="notice-item" href="/d/<%= what %>?noticeid=<%= _id %>#<%= response %>"><%= where.topic %></a>\t\t\t\t\t\t\u56de\u590d\u4e86\u4f60\t\t\t\t\t  \t<a data-mid="<%= _id %>" data-mid="<%= _id %>" class="muted pull-right del">\u4e0d\u518d\u63d0\u9192</a>\t\t\t\t\t  </li>',
...
b.result.count+")");for(var f=0;f<c.length;f++)d+=WE.kit.tmpl(a.noticeItemTmpl,c[f]);d+="</ul>";a.ui.loading.remove();a.ui.list.html(d)}else a.ui.list.html(a.noNoticeTmpl);b.result.count<6&&a.ui.circle.hide()}else a.ui.list.html("<p>"+b.msg+"</p>")};c.addObserver(d);c.noticeList()},deleteOne:function(a){(new WE.api.NoticeModel).noticeStatus(a)}};
