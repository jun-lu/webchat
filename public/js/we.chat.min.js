...
20);a[0].time?WE.pageChat.lastTime=a[0].time:console.log("lastTime \u5931\u8d25")}};WE.pageChat.tabSelect={init:function(){this.ui={tab:$("#tab-select"),content:$("#tab-content")};this.regEvent()},regEvent:function(){var a=this;this.ui.tab.find("a").click(function(){a.ui.content.find(".tab-wall-cell").hide();a.ui.tab.find("a").removeClass("select");$(this).addClass("select")})}};
