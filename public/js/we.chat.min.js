WE.pageChat={isLoading:0,lastTime:null,replyTo:null,isPosting:0,eleId:1,postList:[],isPostInputFocus:!0,init:function(){this.ui={postBox:$("#post-box"),replayBox:$("#replay-box")};WE.pageChat.tabSelect.init();this.regEvent()},regEvent:function(){var a=this;this.ui.postBox.find(".text-box input").keyup(function(b){WE.top.msgNotice.isWindowFocus||(WE.top.msgNotice.isWindowFocus=!0);13==b.keyCode&&(b=$.trim($(this).val()),""!=b&&!a.isPosting&&connectionSocketServer.isLink&&(a.post(ROOM.id,b,a.replyTo),
a.postList.push(a.eleId),WE.pageChat.timeLine.append({eleId:"my-talk-"+a.eleId,_id:"",aim:null,del:0,from:{_id:USER._id,avatar:USER.avatar,name:USER.name,summary:USER.summary},roomid:ROOM.id,text:b,time:"...",to:"*"}),a.ui.postBox.find(".text-box input").val(""),a.hideReply(),a.replyTo=null,a.isPosting=!1,a.eleId++))});$("#timeline-bar").bind("scroll",function(){var b=$(this);0==a.isLoading?0==b.scrollTop()&&0<WE.pageChat.timeLine.leave_count&&(a.isLoading=1,a.getMore()):2==a.isLoading&&0==b.scrollTop()&&
a.noMoreTips()});this.ui.postBox.find(".text-box input").focus(function(){a.isPostInputFocus=!0}).blur(function(){a.isPostInputFocus=!1});$(window).keydown(function(b){13==b.keyCode&&(a.isPostInputFocus||(a.ui.postBox.find(".text-box input").css("background","#FFF8C5"),setTimeout(function(){a.ui.postBox.find(".text-box input").css("background","none")},1500)),a.ui.postBox.find(".text-box input").focus(),a.ui.postBox.find(".text-box input").keyup())})},tipsTimeout:null,noMoreTips:function(){clearTimeout(this.tipsTimeout);
$("#more-talks .tips").text("\u6ca1\u6709\u66f4\u591a\u4fe1\u606f\u4e86...");$("#more-talks").fadeIn();this.tipsTimeout=setTimeout(function(){$("#more-talks").fadeOut()},2E3)},getMore:function(){$("#more-talks").fadeIn();var a=this,b=new WE.api.RoomModel,c=new WE.Controller;c.update=function(b){var c=b.data;setTimeout(function(){0==c.code&&c.result.length?(a.isLoading=0,WE.pageChat.timeLine.leave_count-=c.result.length,WE.pageChat.timeLine.prepends(c.result)):a.isLoading=2;$("#more-talks").fadeOut()},
500)};c.error=function(){$("#more-talks").fadeOut()};b.addObserver(c);b.getMore(ROOM.id,this.lastTime)},post:function(a,b,c){this.isPosting=!0;aim=null==c?void 0:c;c=new WE.api.RoomModel;var d=new WE.Controller;d.update=function(a){};c.addObserver(d);c.postChat(a,b,aim)},setReply:function(a){var b=this;this.replyTo=a._id;this.ui.replayBox.html(WE.kit.tmpl(this.replyTmpl,a));this.ui.replayBox.removeClass("hidden");this.ui.replayBox.find(".close-btn").click(function(){b.ui.replayBox.empty();b.ui.replayBox.addClass("hidden")});
...
WE.pageChat.videoChat={isPlay:!1,videoMap:{},init:function(){this.ui={boot:$("#video-chat"),roomWall:$("#wall-room"),videoWall:$("#video-wall")};this.regEvent()},regEvent:function(){var a=this;this.ui.boot.click(function(){a.isPlay||a.initWall()})},initWall:function(){var a=this;this.ui.roomWall.addClass("video-style");this.ui.videoWall.show();this.ui.boot.find("i").addClass("video-active").attr("title","\u89c6\u9891\u5df2\u7ecf\u5f00\u542f");WE.kit.getTmpl("video-chat.ejs",function(b){b=$(b);WE.extend(a.ui,
{wall:b,close:b.find(".js-close"),list:b.find(".js-list"),view:b.find(".js-view-area")});a.ui.videoWall.empty().append(a.ui.wall);a.initMineVideo();a.moduleRegEvent();a.isPlay=!0})},moduleRegEvent:function(){var a=this;this.ui.close.click(function(){WE.rtc.stopCamera();console.log("==== WE.rtc._socket",WE.rtc);WE.rtc._socket.close();a.ui.videoWall.html("Loading...");a.ui.roomWall.removeClass("video-style");a.ui.videoWall.hide();a.ui.boot.find("i").removeClass("video-active").attr("title","\u70b9\u51fb\u5f00\u542f\u89c6\u9891\u804a\u5929");
a.isPlay=!1})},initMineVideo:function(){var a=this;WE.rtc.socketReady=function(){a.ui.list.empty();WE.rtc.createStream({video:!0,audio:!0},function(b){a.myStream=b;new WE.pageChat.videoChat.cell(USER,b,a.ui.list);a.onViewVideo(b,USER)},function(){});WE.rtc.addRemoteStream=function(b,c){new WE.pageChat.videoChat.cell(c,b,a.ui.list)}};WE.rtc.removeRemoteSteam=function(b){delete a.videoMap[b._id];$("#video-item-"+b._id).remove();a.onViewVideo(a.myStream,USER)};WE.rtc.connect("ws://vchat-rtc.co:8001",
WE.cookie.getCookie("sid"))},onViewVideo:function(a,b){var c=this.ui.view.find("video")[0];b._id==USER._id?c.muted=!0:c.muted=!1;navigator.mozGetUserMedia?(WE.rtc.debug&&console.log("Attaching media stream"),c.mozSrcObject=a,c.play()):c.src=webkitURL.createObjectURL(a)}};WE.pageChat.videoChat.cell=function(a,b,c){var d=this;this.stream=b;this.user=a;WE.kit.getTmpl("video-chat-item.ejs",function(e){e=$(WE.kit.tmpl(e,a));d.ui={wall:e,video:e.find("video")};d.append(c);d.onStream(b);d.regEvent()})};
WE.pageChat.videoChat.cell.prototype={regEvent:function(){var a=this;this.ui.video.click(function(){console.log("\u70b9\u51fb\u4e86");WE.pageChat.videoChat.onViewVideo(a.stream,a.user)})},append:function(a){a.append(this.ui.wall)},onStream:function(a){var b=this.ui.video[0];navigator.mozGetUserMedia?(WE.rtc.debug&&console.log("Attaching media stream"),b.mozSrcObject=a,b.play()):"undefined"!==typeof b.srcObject?b.srcObject=a:"undefined"!==typeof b.mozSrcObject?b.mozSrcObject=a:"undefined"!==typeof b.src&&
(b.src=webkitURL.createObjectURL(a))}};
