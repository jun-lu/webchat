...
"\u70b9\u51fb\u5f00\u542f\u65b0\u6d88\u606f\u58f0\u97f3\u63d0\u793a");a&&this.ui.iconBoot.removeClass("icon-offnoticesound").addClass("icon-onnoticesound").attr("title","\u70b9\u51fb\u5173\u95ed\u65b0\u6d88\u606f\u58f0\u97f3\u63d0\u793a")},onTitleNotice:function(a,b){var c=this;c.noticeTitle=a;clearInterval(this.pointer);if(!c.isWindowFocus){if(c.isSound&&!0==b)this.onSound();this.pointer=setInterval(function(){document.title==c.noticeTitle?document.title=c.defaultTitle:document.title=c.noticeTitle},
1E3)}},onSound:function(){this.sound.currentTime=0;this.sound.play()}};
