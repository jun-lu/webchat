...
WE.pageChat.userlist={tmpl:'<li id="uid_<%=_id%>"><a href="#" title="<%=name%>">\t<img src="<%=avatar%>" width="32"/>\t</a></li>',data:null,init:function(a){var c=0,b="";if(a){for(this.data=a;c<a.length;c++)b+=WE.kit.tmpl(this.tmpl,a[c]);$("#userlist").empty().html(b)}},regEvent:function(){},append:function(a){if(a._id!=USER._id)this.data?this.data.push(a):this.data=[a],$("#userlist").append(WE.kit.tmpl(this.tmpl,a))},remove:function(a){var c=this.data;$("#uid_"+a._id).remove();for(var b=0;b<c.length;b++)if(c[b]._id==
a._id){c.splice(b,1);break}},historyList:function(a){var c=this,b=new WE.api.ChatModel,d=new WE.Controller;d.update=function(a){var a=a.data,b="";if(a.code==0){for(var d=0;d<a.result.length;d++)b+=WE.kit.tmpl(c.tmpl,a.result[d]);$("#history-list").empty().html(b)}};b.addObserver(d);b.historyList(a)}};
