...
WE.pageChat.roomEdit={init:function(){this.ui={boot:$("#room-edit-boot"),box:$("#room-edit-box"),titleBox:$("#title-box"),checkpwd:$("#checkpwd"),password:$("#password"),topic:$("#topic-name"),form:$("#room-edit-form")};this.regEvent()},regEvent:function(){var a=this;this.ui.boot.click(function(){a.ui.titleBox.height("100%");a.ui.topic.focus();a.ui.box.show()});this.ui.box.find(".close-btn").click(function(){a.ui.titleBox.height("auto");a.ui.box.hide()});this.ui.box.find(".topic-edit-submit").click(function(){console.log("topic",
a.ui.topic);var b=$.trim(a.ui.topic.val()),c=$.trim(a.ui.password.val());if(""!=b)return a.post(ROOM.id,b,c),!1});this.ui.checkpwd.change(function(){if(!a.ui.checkpwd.is(":checked"))return a.ui.passowrd.hide(),a.ui.passowrd.val(""),!1;a.ui.passowrd.show()})},post:function(a,b,c){var d=new WE.api.RoomModel,e=new WE.Controller;e.update=function(a){0==a.data.code&&location.reload()};d.addObserver(e);d.updateRoomBase(a,b,c)}};
