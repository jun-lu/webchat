...
WE.pageChat.invite={selectList:[],datas:[],isGetData:!1,init:function(){var a=$("#invite");this.ui={wall:$("#wall-room"),inviteWall:a,boot:$("#invite-btn"),close:a.find(".close-btn"),usersList:$("#users-list")};this.regEvent()},regEvent:function(){var a=this;this.ui.boot.click(function(){a.ui.wall.addClass("invite-style");a.isGetData||a.getUserList()});this.ui.close.click(function(){a.ui.wall.removeClass("invite-style")});this.ui.usersList.find(".cell").click(function(){var a=$(this);a.index();var c=
a.hasClass("select-cell");c?a.removeClass("select-cell"):a.addClass("select-cell");c?a.find(".select").addClass("hidden"):a.find(".select").removeClass("hidden");c?a.find(".invite").show():a.find(".invite").hide()})},getUserList:function(){var a=this,b=new WE.api.UserModel,c=new WE.Controller;c.update=function(b){b=b.data;a.isGetData=!0;a.datas=b};b.addObserver(c);b.getContactList()}};
