...
a));$("#timeline-bar").scrollTop(99999)},appends:function(a){for(var b=0,c=a.length,d="";b<c;b++)this.mapData[a[b]._id]=a[b],d+=WE.kit.tmpl(this.tmpl,a[b]);$("#timeline-talks").append(d);a[0].time?WE.pageChat.lastTime=a[0].time:console.log("lastTime \u5931\u8d25");$("#timeline-bar").scrollTop(99999)},prepends:function(a){for(var b=0,c=a.length,d="";b<c;b++)this.mapData[a[b]._id]=a[b],d+=WE.kit.tmpl(this.tmpl,a[b]);b=$(d);b.insertAfter($("#more-talks"));var e=0;$.each(b,function(a,b){e+=b.offsetHeight});
...
WE.pageChat.invite={selectList:{mail:[],user:[]},datas:[],isGetData:!1,mailInputList:[],init:function(){var a=$("#invite");this.ui={wall:$("#wall-room"),inviteWall:a,boot:$("#invite-btn"),close:a.find(".js-close-btn"),usersList:$("#users-list"),emailInput:a.find(".email-input"),emailTips:a.find(".email-input .error-tips")};this.regEvent()},regEvent:function(){var a=this;this.ui.boot.click(function(){a.ui.wall.addClass("invite-style");a.isGetData||a.getUserList()});this.ui.close.click(function(){a.ui.wall.removeClass("invite-style");
a.ui.usersList.empty();a.ui.emailInput.find("input").val("")});this.ui.usersList.find(".cell").click(function(){var a=$(this);a.index();var c=a.hasClass("select-cell");c?a.removeClass("select-cell"):a.addClass("select-cell");c?a.find(".select").addClass("hidden"):a.find(".select").removeClass("hidden");c?a.find(".invite").show():a.find(".invite").hide()});this.ui.emailInput.find("input").keyup(function(b){var c=$.trim(a.ui.emailInput.find("input").val());if(13==b.keyCode&&""!=c){if(!/^[^@]+@[^@]+$/.test(c))return a.ui.emailTips.text("Please input email").show(),
setTimeout(function(){a.ui.emailTips.hide()},2E3),a.ui.emailInput.find("input").val(""),!1;b=a.selectList.mail.length;for(var d=a.selectList.mail,e=!1,f=0;f<b;f++)if(d[f].mail==c){e=!0;a.ui.emailTips.text("Email already exists").show();setTimeout(function(){a.ui.emailTips.hide()},2E3);break}e||a.addUser({mail:c},!0);a.ui.emailInput.find("input").val("")}});this.ui.emailInput.find("input").focus(function(){a.ui.emailTips.hide()})},addUser:function(a,b){(new WE.pageChat.inviteCell(a,b)).prepend(this.ui.usersList)},
getUserList:function(){var a=this,b=new WE.api.UserModel,c=new WE.Controller;c.update=function(b){b=b.data;0==b.code&&(a.isGetData=!0,a.datas=b.result)};b.addObserver(c);b.getContactList()}};
WE.pageChat.inviteCell=function(a,b){this.data=a;this.select=b||!1;this.list=(this.isUserList="undefined"!=typeof a.name?!0:!1)?WE.pageChat.invite.selectList.user:WE.pageChat.invite.selectList.mail;this.listIndex=this.list.length;var c=WE.kit.tmpl(this.itemTmpl,{user:a,select:b});wall=$(c);this.ui={wall:wall,invite:wall.find(".invite-js-btn"),cell:wall.find(".cell")};this.select&&this.addUser();this.init()};
