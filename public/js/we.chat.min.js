...
this.ui.submit.click(function(){(a.selectList.mail.length||a.selectList.user.length)&&a.invitePost()})},addUser:function(a,b){(new WE.pageChat.inviteCell(a,b)).prepend(this.ui.usersList)},addUsers:function(a){for(var b=a.length,c=0;c<b;c++)this.addUser(a[c].to,!1)},getUserList:function(){var a=this,b=new WE.api.UserModel,c=new WE.Controller;c.update=function(b){b=b.data;0==b.code&&(a.isGetData=!0,a.datas=b.result,a.addUsers(a.datas))};b.addObserver(c);b.getContactList()},invitePost:function(){var a=
new WE.api.RoomModel,b=new WE.Controller;b.update=function(a){console.log("data",a.data)};a.addObserver(b);a.inviteChat(this.selectList.user,this.selectList.mail,ROOM.id)}};
