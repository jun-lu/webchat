...
WE.pageChat.inviteCell.prototype={itemTmpl:'<li>\t\t\t\t<div class="cell <% if( select ){ %> select-cell <% } %>">\t\t\t\t\t<% if( typeof user.avatar != "undefined" ){ %>\t\t\t\t\t<img src="<%=user.avatar %>">\t\t\t\t\t<% } %>\t\t\t\t\t<%=user.name || user.mail %>\t\t\t\t\t<% if( select ){ %>\t\t\t\t\t\t<div class="invite-js-btn">\t\t\t\t\t\t\t<span class="select select-type">\u221a</span>\t\t\t\t\t\t\t<span class="btn invite-type invite" style="display:none;">Invite</span>\t\t\t\t\t\t</div>\t\t\t\t\t<% }else{ %>\t\t\t\t\t\t<div class="invite-js-btn">\t\t\t\t\t\t\t<span class="select select-type hidden">\u221a</span>\t\t\t\t\t\t\t<span class="btn invite-type invite">Invite</span>\t\t\t\t\t\t</div>\t\t\t\t\t<% } %>\t\t\t\t</div>\t\t\t</li>',
