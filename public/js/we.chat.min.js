...
this.ui.replayBox.addClass("hidden")},replyTmpl:'<div class="replay-box">\t\t\t\t\t<div class="arrow"></div>\t\t\t\t\t<span class="icon-close close-btn"></span>\t\t\t\t\t<div>\t\t\t\t\t\t<a href="/user/<%=from._id%>" target="_blank" class="name"><%=from.name == ""? "(\u6682\u65e0\u6635\u79f0)" : from.name %></a> : \t\t\t\t\t</div>\t\t\t\t\t<div class="context"><%=text %></div>\t\t\t\t</div>'};
...
a.isPlay=!1})},initMineVideo:function(){var a=this;WE.rtc.socketReady=function(){a.ui.list.empty();WE.rtc.createStream({video:!0,audio:!1},function(b){a.myStream=b;new WE.pageChat.videoChat.cell(USER,b,a.ui.list);a.onViewVideo(b)},function(){});WE.rtc.addRemoteStream=function(b,c){console.log("================== addRemoteStream",c._id);new WE.pageChat.videoChat.cell(c,b,a.ui.list)}};WE.rtc.removeRemoteSteam=function(b){delete a.videoMap[b._id];$("#video-item-"+b._id).remove();a.onViewVideo(a.myStream)};
WE.rtc.connect("ws://vchat-rtc.co:8001",WE.cookie.getCookie("sid"))},onViewVideo:function(a){var b=this.ui.view.find("video")[0];navigator.mozGetUserMedia?(WE.rtc.debug&&console.log("Attaching media stream"),b.mozSrcObject=a,b.play()):b.src=webkitURL.createObjectURL(a)}};WE.pageChat.videoChat.cell=function(a,b,c){var d=this;this.stream=b;WE.kit.getTmpl("video-chat-item.ejs",function(e){e=$(WE.kit.tmpl(e,a));d.ui={wall:e,video:e.find("video")};d.append(c);d.onStream(b);d.regEvent()})};
WE.pageChat.videoChat.cell.prototype={regEvent:function(){var a=this;this.ui.video.click(function(){console.log("\u70b9\u51fb\u4e86");WE.pageChat.videoChat.onViewVideo(a.stream)})},append:function(a){a.append(this.ui.wall)},onStream:function(a){var b=this.ui.video[0];navigator.mozGetUserMedia?(WE.rtc.debug&&console.log("Attaching media stream"),b.mozSrcObject=a,b.play()):b.src=webkitURL.createObjectURL(a)}};
