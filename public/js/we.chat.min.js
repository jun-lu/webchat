...
$.trim(e.val()),c=new WE.api.ChatModel,b=new WE.Controller;b.update=function(a){a=a.data;e.removeClass("error");a.code==0?(d=!0,f.find(".keyerror").hide(),e.removeClass("error")):(d=!1,f.find(".keyerror").text(a.msg).show(),e.addClass("error"))};c.addObserver(b);c.uniqueKey(a)});f.submit(function(){var a=l.val(),b=e.val(),f=j.val(),g=k.val(),b=b==a?"":b;if(f&&g&&d){var h=new WE.api.ChatModel,i=new WE.Controller;i.update=function(d){d.data.code==0&&(c.close(),setTimeout(function(){window.location.href=
"http://"+window.location.host+"/"+(b||a)},500))};h.addObserver(i);h.updateRoom(a,b,f,g)}return!1})})},getMore:function(){var a=this,c=new WE.api.ChatModel,b=new WE.Controller;b.update=function(b){b=b.data;b.code==0&&b.result.length?(a.isLoading=0,WE.pageChat.timeLine.appends(b.result)):a.isLoading=2};c.addObserver(b);c.getMore(ROOM.id,this.lastTime)},selectAvatar:function(a){function c(){var a=WE.kit.getRadioValue("gravatarAvatar"),b=new WE.api.ChatModel,c=new WE.Controller;c.update=function(a){a.data.code==
0&&document.location.reload()};b.addObserver(c);b.updateAvator(a)}var b=a.hexMail,d=new WE.Dialog({title:"\u9009\u62e9\u5934\u50cf",id:"selectAvatar"});d.show();WE.kit.getTmpl("select_avatar.ejs",function(e){d.append(e);$("#"+a.gravatarDefault).attr("checked","checked");$("#setAvator").submit(function(){c();return!1});$("#setAvator li img").each(function(){$(this).attr("src",WE.kit.getAvatar(b,48,$(this).data("avatar")))})})}};
