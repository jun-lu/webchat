...
f.__vchat_config.uname||"\u533f\u540d";this.config.uavatar=f.__vchat_config.uavatar||null;this.config.topic=f.__vchat_config.topic||"";this.config.des=f.__vchat_config.des||""},addMainUI:function(){d.appendHTML(document.body,'<div class="vchat-wrapper">\t\t\t\t\t\t\t<div class="vchat-chats-wrapper" id="__vchat_chat_wrap"></div>\t\t\t\t\t\t\t<div class="vchat-main vchat-main-mini" id="__vchat_main" >\t\t\t\t\t\t\t\t<div class="vchat-self-card" id="__vchat_self" ></div>\t\t\t\t\t\t\t\t<div class="vchat-user-list" id="__vchat_online_user"></div>\t\t\t\t\t\t\t\t<div class="vchat-user-init" id="__vchat_init" onclick="__vchat.openAndClose()" >V-chat</div>\t\t\t\t\t\t\t</div>\t\t\t\t\t</div>');
...
1),a};__vchat.chat.open=function(a,b){var c=__vchat.userList.getUser(a),e=null;if(a==__vchat.user._id)return window.console&&console.log("miss self"),!1;if(c){for(e=0;e<this.list.length;e++)if(this.list[e].user._id==a){this.list[e].setNoraml();return}this.list.length>6&&this.list[0].setClose();e=new __vchat.chat(c,__vchat.room.id,b==void 0?!0:!1);this.list.push(e)}};__vchat.chat.newMessage=function(a){var b=0;if(a.to&&a.to._id==__vchat.user._id||a.from._id==__vchat.user._id)for(var c=0;c<this.list.length;c++){if(this.list[c].newChat(a)){b=
...
this,b=this.data.roomid,c=this.data.text,d=this.data.to._id,f=this.data.from._id;a.showSendIngStatus();__vchat.api.postMessage(b,c,d,f,null,function(){a.stopSendIngStatus();a.ui.status.innerHTML=""},function(){a.ui.status.innerHTML="error"})},stopSendIngStatus:function(){clearInterval(this.interid)},showSendIngStatus:function(){var a=this,b=0;this.interid=setInterval(function(){a.ui.status.innerHTML="...".slice(0,++b%3+1)},300)}};(__vchat_config.init==void 0||__vchat_config.init)&&__vchat.init()}else window.console&&
