...
DbModel.prototype.update = function( selecter, object ){
	...
	db.open(function(error, client){
		...
		console.log("selecter", selecter, object );
		collection.update( selecter, {"$set":object} , {multi:true} ,function(err, data){
			db.close();
...
//修改数据
DbModel.prototype.remove = function( selecter, object ){
	...
	db.open(function(error, client){
		...
		collection.remove( selecter, function(err, data){
			db.close();
			_this.emit( _this.onremove, err, data);
