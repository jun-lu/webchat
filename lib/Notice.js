...
/*
	...
	from 在 where 中 提到了 to, what ? 

*/
var ObjectID = require('mongodb').ObjectID;

var Notice = module.exports = function( type, from, to, where, what){
...
Notice.factory = function( json ){
	...
	var notice = new Notice( json.type, json.from, json.to, json.where, json.what);
